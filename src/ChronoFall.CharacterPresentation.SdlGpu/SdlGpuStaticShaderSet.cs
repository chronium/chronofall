...
public sealed class SdlGpuStaticShaderSet
{
    public SdlGpuStaticShaderSet(
        ...
        string entryPoint)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(format), "Static mesh shaders support MSL or SPIR-V bytecode.");
        }
